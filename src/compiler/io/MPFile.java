...
public class MPFile {
     ...
     * 
     * @param linewrap
     *            if true it will continue checking for characters until there are no more lines otherwise it will only check the current
     *            line
     ...
     * 
     * @param linewrap
     *            if true it will continue until the end of file otherwise the end of the line
     * @return the character found
     * @throws EOFException
     *             - only when linewrap is true and it cannot find any more characters
     * @post lineIndex will be on the line with the returned character if there are more characters, the next line that has characters, or
